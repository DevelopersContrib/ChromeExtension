document.getElementById("startwebcrape").addEventListener('click', () => {
	function modifyDOM() {
			...
			if($('#selector').length==0){
				...
				$("body").prepend('<div id="tbl-container" class="stdform" style="margin-left:10px">'+
				'<hr>'+
				'<button class="btn btn-primary btn-proceed btn-tbl" style="display:none;background: #333;margin-bottom:10px">Proceed to Research</button>'+
				'<button style="display:none;background: #333;margin-bottom:10px" class="btn-tbl btn btn-danger  btn-remove">Delete Selected</button>'+
